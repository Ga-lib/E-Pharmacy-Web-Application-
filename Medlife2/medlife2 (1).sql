...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2023 at 08:25 AM
...
INSERT INTO `doctor_info` (`id`, `Name`, `speciality`, `Gender`, `Experience`) VALUES
(1, 'Dr.Galib', 'Cardiologist', 'male', 10),
(2, 'Dr.Rapa', 'Dermatology', 'female', 8),
(3, 'Dr.Rahim', 'Cardiologist', 'male', 5),
(4, 'Dr.Jubair', 'Cardiologist', 'male', 15),
(5, 'Dr.Ahmed', 'Dentistry', 'male', 7),
(6, 'Dr.Sara', 'Diabetology', 'female', 12),
(7, 'Dr.Khan', 'Cardiologist', 'male', 9),
(8, 'Dr.Lisa', 'Dermatology', 'female', 6);
...
(163, 11, 30, 6, '2023-10-28 06:20:32'),
(164, 11, 2, 1, '2023-10-28 06:22:01');
...
(10, 'eqrteryet@gmail.com', 'rethrjkylu.', NULL, NULL, 'user'),
(11, 'rahimulhaque1971@gmail.com', '1234', 'Pabna ', '+88001300985743', 'user');
...
--
ALTER TABLE `cart`
  MODIFY `CartID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;
...
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `appointment_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`UserID`),
  ADD CONSTRAINT `appointment_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `doctor_info` (`id`);
